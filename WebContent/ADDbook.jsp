...
<html lang="en">
    <head>
        ...
        <title>Write A Book And Publish - PDF Free Download - EPDF.PUB</title>
	...
	<div class="header">
		<div class="navbar navbar-blue" role="navigation">
			...
			<ul class="nav navbar-nav">
			    <li class="active"><a href="Panier?cont=${3*2}"><i class="fa fa-home"></i>My Packet</a></li>
	...
	<div class="col-md-12 text-justify">
	    <h2 class="main-title">Write A Book or PDF for Free Download</h2>
	    <label>Write a book, elevate your profile, build a business - Upload ideas and beginner tips to get you started</label>	
	</div>
    </div>
</div>
...
<div class="container-fluid">
            ...
            <div class="row mb-30">
	    <div class="col-md-12">
		<h2 class="main-title">Add Documents</h2>
	    </div>
                    ...
                    <div class="form-group">
                       <label class="form-label col-sm-3" for="email">Email</label>
		                <div class="col-sm-9">
			            <input class="form-input form-control" type="text" name="email" id="email" value="" placeholder="xxxxxxxx@gmail.com" required/>
		               </div>
                     </div>
                     ...
                     <div class="form-group">
		                ...
		                <div class="col-sm-9">
			            <input class="form-input form-control" type="password" name="password" id="password" value="" placeholder="Password" required/>
		                </div>
                     </div>
                       ...
                       <div class="form-group">
                           <label class="form-label col-sm-3" for="name">Book File</label>
		                   <div class="col-sm-9">
			               <input class="form-input form-control" type="file" name="file" id="name" value="" placeholder="file" required/>
		                 </div>
                       </div>
                       
                       
                        <div class="form-group">
                           <label class="form-label col-sm-3" for="name">Book Name</label>
		                   <div class="col-sm-9">
			               <input class="form-input form-control" type="text" name="bookName" id="name" value="" placeholder="bookName" required/>
		                 </div>
                       </div>
                       
                       
                        <div class="form-group">
                           <label class="form-label col-sm-3" for="name">author Name</label>
		                   <div class="col-sm-9">
			               <input class="form-input form-control" type="text" name="auteurName" id="name" value="" placeholder="author Name" required/>
		                 </div>
                       </div>
                       
                       
                        <div class="form-group">
                           <label class="form-label col-sm-3" for="name">Book Date</label>
		                   <div class="col-sm-9">
			               <input class="form-input form-control" type="text" name="bookdate" id="name" value="" placeholder="Date" required/>
		                 </div>
                       </div>
                       
                       
                        <div class="form-group">
                           <label class="form-label col-sm-3" for="name">price</label>
		                   <div class="col-sm-9">
			               <input class="form-input form-control" type="number" name="prix" id="name" value="" placeholder="price" required/>
		                 </div>
                       </div>
	...
	<!-- ********************************************************************************************************* -->	    
			<form method="post"  action="Auth" >
				...
				<div class="checkbox">
				    ...
				    <label class="pull-right"><a href="#">Forgot password?</a></label>
				</div>
