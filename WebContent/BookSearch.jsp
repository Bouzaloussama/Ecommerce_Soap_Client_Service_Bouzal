	    	...
	    	<div class="col-lg-2 col-md-3 col-xs-6">
                  <div class="note">
	                <div class="note-meta-thumb">	
		             ...
		             <h3 class="note-title">${Book.getBookName().replaceAll("-"," ")}</h3>
	                </a>
	               </div>
	                   ...
	                   <br>
                        the author Name : ${Book.getAuteurName()}<br>
                        Prix of this Book is : ${Book.getPrix()} Dh<br>
                        <a aligne ="right" href="http://localhost:8084/Ecommerce_Soap_Client_Service_Bouzal/Panier?idBook=${Book.getId()}">Add Packet</a>
