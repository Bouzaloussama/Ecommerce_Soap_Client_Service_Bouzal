...
<html lang="en">
    <head>
        ...
        <title>Write A Book And Publish - PDF For Download</title>
...
<!-- ###################################################################################### -->
	...
	<a class="active" href="http://localhost:8084/Ecommerce_Soap_Client_Service_Bouzal/JSPpage/profile.jsp"><lable>&emsp;<strong>Profile</strong></lable></a>
	<div class="container-fluid mt-15 mb-30">
    <div class="row">
	<div class="col-md-12 text-justify">
	    <h2 class="main-title">Write A Book or PDF for Download</h2>
	                ...
	                <div class="note-meta-thumb">	
		             ...
		             <h3 class="note-title"><%=b.getBookName().replaceAll("-"," ")%></h3>
	                   ...
	                   <div class="note-action">
	                     <a class="more-link" href="http://localhost:8084/Ecommerce_Soap_Client_Service_Bouzal/HTMLpage/ThinkLikeAman.html">Read more</a>&emsp;&emsp;&emsp;&nbsp;<br>
	                     <a aligne ="right" href="Panier?idBook=<%=b.getId() %>">Add to Packet</a> &emsp;&emsp; <%=b.getPrix() %> DH
	                   </div>
                   </div>
                 </div> 
